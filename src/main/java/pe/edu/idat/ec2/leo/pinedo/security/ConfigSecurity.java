package pe.edu.idat.ec2.leo.pinedo.security;
...
public class ConfigSecurity extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
			.antMatchers("/producto/version1/guardar").access("hasRole('ADMIN')")
			.antMatchers("/producto/version1/listar").permitAll()
			.and()
			.httpBasic()
			.and()
			.csrf().disable();
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
		...
		http.authorizeRequests()
			.antMatchers("/producto/version1/*").access("hasRole('ADMIN')")
			.and()
			.httpBasic()
			.and()
			.csrf().disable();
